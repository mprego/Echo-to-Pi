...
class cmd_handler(debounce_handler):
    TRIGGERS = {"pitbull": 52001}
    def act(self, client_address, state, name):
	on_cmd = 'python ~/Documents/GreenLight/Greenlight.py'
	os.popen(on_cmd)
	print 'playing GreenLight Dale'
	return True
...
if __name__ == "__main__":
    ...
    # Add command handler
    c = cmd_handler()
    for trig, port in c.TRIGGERS.items():
	fauxmo.fauxmo(trig, u, p, None, port, c)
